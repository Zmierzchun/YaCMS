...
use YaCMSBundle\Entity\MenuItem;
use YaCMSBundle\Form\MenuItemType;
...
class MenuItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $menuItems = $em->getRepository('YaCMSBundle:MenuItem')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('YaCMSBundle\Form\MenuItemType', $menuItem);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_menu_item_show', array('id' => $menuItem->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($menuItem);
        $editForm = $this->createForm('YaCMSBundle\Form\MenuItemType', $menuItem);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_menu_item_edit', array('id' => $menuItem->getId()));
        }
    ...
    public function deleteAction(Request $request, MenuItem $menuItem)
    {
        ...
        return $this->redirectToRoute('admin_menu_item_index');
    }
    ...
    private function createDeleteForm(MenuItem $menuItem)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_menu_item_delete', array('id' => $menuItem->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
